  ...
  const now = 37;
    return(
        <section className="banner" id="hero">
            ...
            <figure className="hero_middle_img d-none d-md-block">
                    ...
                    <Row className='align-items-center'>
                        <Col lg={7}>
                            <div className="banner-content">
                                <h1>SPRINGFIELD AND <span>{dollarSign} BART</span></h1>
                                ...
                                <figure className="hero_middle_small_device_img d-md-none">
                                    <img src={hero_m_img} alt="" />
                                </figure>
                            </div>
                        </Col>
                                            ...
                                            <div className="countdown_box_bottom">
                                                ...
                                                <div className="amount pay mb-3">
                                                    ...
                                                    <div className="amount_box d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div className="right">
                                                            <span><input type="number" name="number" placeholder="0" id="number" /></span>
                                                        </div>
                                                    </div>
                                                </div>
